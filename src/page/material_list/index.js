...
import {
  ...
  DownOutlined,
  CloseCircleOutlined, ReloadOutlined, DeleteFilled, ExclamationCircleOutlined, FullscreenOutlined, SearchOutlined, LoadingOutlined, EditFilled, DeleteOutlined
} from '@ant-design/icons'
import {
  Input, Modal, Tabs, Form, Skeleton, Button, Popover, Dropdown, Space,
  Menu, Select, AutoComplete, Checkbox, Tooltip, Pagination, DatePicker, Popconfirm
} from 'antd';
...
const App = () => {
  ...
  const _handleSaveAll = async () => {
    try {
      ...
      insertObj(KEY_STORE.material, _.keyBy(dataToSave, 'id'));
  ...
  return (
    <div>
      <GeneralHeader title='List material_old' Com={
