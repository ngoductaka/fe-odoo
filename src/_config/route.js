...
export const private_route = [
    ...
    },
    {
        ...
        Com: RfidMaterial,
        exact: true,
        name: 'Scan Material Out Warehouse',
        // hidden: true,
    },
    {
        path: `/${ROUTES.RFID_IN_FACTORY}`,
        Com: ConfirmInFactory,
        exact: true,
        name: 'Scan Material In Factory',
        // hidden: true,
    },
    {
        path: `/${ROUTES.BackToWh}`,
        Com: BackToWh,
        exact: true,
        name: 'Scan Material Back To Warehouse',
        // hidden: true,
    },
    {
